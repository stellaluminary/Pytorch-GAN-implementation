...
class SNGANModel(BaseModel):
    def __init__(self, opt):
        super(SNGANModel, self).__init__(opt)
        ...
        if self.is_train == 'train':
            ...
            # define loss for vanilla gan loss
    ...
    def optimize_parameters(self, idx):
        ...
        if self.loss_type == 'hinge':
            loss_D_real = torch.mean(nn.ReLU()(1.0 - disc_real))
            loss_D_fake = torch.mean(nn.ReLU()(1.0 + disc_fake))
